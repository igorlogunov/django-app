...
sentry_sdk.init(
    dsn="https://9c1f33620da04f739521c85d99be5236@o4505408963346432.ingest.sentry.io/4505408972193792",
...
SECRET_KEY = getenv(
    "DJANGO_SECRET_KEY",
    'django-insecure-a-prps)1@_61))bow#znq(7!x9gv_5#xay9a5r)d4*#u^j32#4',
)
...
ALLOWED_HOSTS = [
    "0.0.0.0",
    "127.0.0.1",
] + getenv("DJANGO_ALLOWES_HOSTS", "").split(",")
INTERNAL_IPS = [
    "127.0.0.1",
]
